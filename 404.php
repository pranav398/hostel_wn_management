...
<head>
    ...
    <title>Page Not Found (404) | HWMM</title>
    ...
    <main class="flex-1 flex items-center justify-center p-6 z-10 relative">
        <div class="w-full max-w-md text-center space-y-6">
            ...
            <div class="space-y-2">
                ...
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">The page you requested has been washed away or doesn't exist.</p>
            </div>

            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                <a href="dashboard.php" class="w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-xs font-bold shadow-lg shadow-blue-500/25 transition">Return to Dashboard</a>
                <a href="booking.php" class="w-full sm:w-auto px-6 py-3 bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 text-slate-800 dark:text-slate-200 rounded-2xl text-xs font-bold transition">Book Machine</a>
            </div>
        </div>
    </main>
